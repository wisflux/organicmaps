...
//    let fileURL = tempDirectory.appendingPathComponent("test.kml")
//    var string = "test"
//    var fileData = string.data(using: .utf8)!
//
//    if !fileManager.createFile(atPath: fileURL.path, contents: fileData, attributes: nil) {
//      XCTFail("Failed to create file at path: \(fileURL.path)")
//    }
//
//    mockDelegate.didFinishGatheringExpectation = didFinishGatheringExpectation
//    mockDelegate.didUpdateExpectation = didUpdateExpectation
...
//
//    fileData = string.appending("2").data(using: .utf8)!
//    do {
//      try fileData.write(to: tempDirectory.appendingPathComponent("test.kml"))
//    } catch {
//      XCTFail("Failed to write data to file: \(error)")
//    }
//    wait(for: [didUpdateExpectation], timeout: 5)
//  }
